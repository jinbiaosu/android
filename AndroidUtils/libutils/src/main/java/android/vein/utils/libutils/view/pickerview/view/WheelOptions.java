...
//import com.mobcent.widget.pickerview.adapter.ArrayWheelAdapter;
...
//			len = 12;
//		// 选项1
//		DZResource resource = DZResource.getInstance(view.getContext());
//		wv_option1 = (WheelView) view.findViewById(resource.getViewId("options1"));
//		wv_option1.setAdapter(new ArrayWheelAdapter(mOptions1Items, len));// 设置显示数据
//		wv_option1.setCurrentItem(0);// 初始化时显示的数据
//		// 选项2
//		wv_option2 = (WheelView) view.findViewById(resource.getViewId("options2"));
...
//		// 选项3
//		wv_option3 = (WheelView) view.findViewById(resource.getViewId("options3"));
