...
import com.vein.translater.utils.TranslatorConstant;
...
public class TranslatorApplication extends Application {
	private String appID = TranslatorConstant.APP_ID;
	private String appKey = TranslatorConstant.APP_KEY;
	public final static String TAG = TranslatorApplication.class.getName();
	...
	public void onCreate() {
		...
		if (shouldInit()) {
			MiPushClient.registerPush(this.getApplicationContext(),
					TranslatorConstant.APP_ID, TranslatorConstant.APP_KEY);
		}
		// 打开Log
